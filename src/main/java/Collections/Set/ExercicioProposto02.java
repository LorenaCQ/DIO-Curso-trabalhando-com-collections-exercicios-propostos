...
public class ExercicioProposto02 {
    public static void main(String[] args) {
        ...
        linguagensFavoritas.add(new LinguagemFavorita("Flutter", 2017, "Visual Studio Code"));
        linguagensFavoritas.add(new LinguagemFavorita("JavaScript", 1995, "IntelliJ"));
        ...
        Set<LinguagemFavorita> minhasLinguagensFavoritas1 = new LinkedHashSet<>(
                Arrays.asList(
                        new LinguagemFavorita("Flutter", 1991, "Pycharm"),
        ...
        Set<LinguagemFavorita> minhasLinguagensFavoritas2 = new TreeSet<>(linguagensFavoritas);
        ...
        minhasLinguagensFavoritas3.addAll(linguagensFavoritas);
        ...
        minhasLinguagensFavoritas4.addAll(linguagensFavoritas);
